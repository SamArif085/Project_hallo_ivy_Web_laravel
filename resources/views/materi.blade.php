...
@section('content')
    <div id="content">
        ...
        <button type="button" id="btn-utama" class="btn" data-bs-toggle="modal" data-bs-target="#exampleModal" style="margin-left: 15px; margin-top:15px; width:120px">
            Quiz
        </button>
        <div class="tabel">
